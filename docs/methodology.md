...
I therefore developed the YOLOv5_FPC model by fine-tuning YOLOv5 with self-collected FPC training data. This was the domain adaptation step that converted a general object detector into a task-specific detector for four-panel cartoons in historical newspaper pages.
